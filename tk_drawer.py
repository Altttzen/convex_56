...
class TkDrawer:
    ...
    def draw_square(self, a, b, c, d):
        self.canvas.create_line(x(a), y(a), x(b), y(b), fill="red", width=2)
        self.canvas.create_line(x(b), y(b), x(c), y(c), fill="red", width=2)
        self.canvas.create_line(x(c), y(c), x(d), y(d), fill="red", width=2)
        self.canvas.create_line(x(d), y(d), x(a), y(a), fill="red", width=2)
        self.root.update()
