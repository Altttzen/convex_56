...
class Segment(Figure):
    ...
    def count_sq(self):
        return self.p.is_dist() + self.q.is_dist()
...
class Polygon(Figure):
    ...
    def __init__(self, a, b, c):
        ...
        self._count_sq = a.is_dist() + b.is_dist() + c.is_dist()
    ...
    def add(self, t):
        ...
        if t.is_light(self.points.last(), self.points.first()):
            ...
            self._count_sq += t.is_dist()
        return self

    def count_sq(self):
        return self._count_sq
